...
# 2. Stops the ENTIRE cluster.
# 3. Restarts the cluster — name node restores from checkpoint/journal,
#    data nodes send block reports to repopulate block-to-node mappings.
...
echo
echo "═══════════════════════════════════════════"
echo " Phase 3 — Restart cluster"
echo "═══════════════════════════════════════════"

# remove containers so they restart cleanly; volumes are preserved
